---
layout: post
title: Joining Microsoft, and relocating to Vancouver/Seattle.
date: 2015-10-27 12:00
published: true
comments: true
draft: true
categories:
og_image: images/posts/joining-microsoft/social.png
---

It’s now almost a year ago I decided to [leave Citrix and take a break](/blog/2014/12/12/leaving-citrix-time-for-a-break/). Back in December 2014 there wasn’t any bigger plan, other than I needed a break to reflect how I should be spending my time going forward. Back then I outlined a few things I wanted to do, like taking [ColdFront](https://coldfrontconf.com) to the next level, and spending more time on projects like [RemoteDebug](http://remotedebug.org). When looking back at 2015 I’ve actually managed to do most of the things I outlined a year ago.

{% img /images/posts/joining-microsoft/social.png %}
...
However the most important thing during 2015 has been that I’ve had the time to take a step back and reflect on what I really wanted to do going forward. During this process it became clear that “my mission” since the early days been about empowering people to build software.

When looking back, this was what made me join [Podio](https://podio.com). Our mission with [Podio](https://podio.com) was to empower non-technical people to build their own work tools, by using Podio as the platform to build “apps”. With this in mind, and when looking at the projects I’ve been doing in my spare time, and the talks I’ve given at a number of conferences, it became crystal clear to me, that the next thing I should be doing, had to be making it easier to build software.
...
In my role I’m going to focus on the overall web development workflow, that in real-life involves multiple tools. My mission is to make our daily web development workflow simpler and more efficient. When looking at the modern workflow I think there’s room for much improvement, as I don’t think our existing tooling has managed to solve some of the most fundamental issues, that I’m seeing developers face each and every day.
...
## What, wait, relocating to Vancouver and Seattle?

As many of you know, the american visa situation is a bit of a mess, so in January 2016, I’ll be relocating to Vancouver, Canada, so I can be in the same timezone, and to be relatively close to the team in Seattle. Once I’ll get my american visa granted, I’ll be relocating once again to Seattle, where I’ll be working out of the Microsoft HQ in Redmond,

{% img /images/posts/joining-microsoft/seattle.jpg %}
